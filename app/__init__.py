...
from app.routes.posts import bp as bp_post
from app.routes.products import bp as bp_prod
from app.routes.orders import bp as bp_ped
...
def create_app():
    ...
    @app.route('/')
    def index():
        return {"message": "API Tennis shop"}
